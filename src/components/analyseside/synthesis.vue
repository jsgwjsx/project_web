<template>
    <div class="pop_container">
        ...
        <div class="gridcontrol">
            ...
            <img src="/public/舆情分析.png" alt=""class="any">
            舆情分析辅助
        </div>
        <div class="control">
        ...
        <div class="gridcontrol">
            ...
            <img src="/public/道路-线.png" alt="" class="any">
            道路综合分析
        </div>
        <div class="controls">
            ...
            <div class="bufferset">
                <div style="width: 80px;height: 26px;line-height: 26px;margin: 5px;" class="buffer">缓冲区/m:</div><el-slider
    ...
    methods: {
            ...
            if (this.$store.state.button3 == '加载poi') {
                if (!this.$store.state.savedata) {
                    poi_layer = new FeatureLayer({
                        url: '/arcgis/arcgis/rest/services/project1/point/MapServer/0',
                        fields: [
                            {
                                name: 'name',
                                alias: 'name',
            ...
            if (!features) {
                ...
                if (!analydata) {
                    ...
                    features.queryFeatures(query)
                        .then(function (res) {
                            var gpUrl = '/arcgis/arcgis/rest/services/project1/buffers/GPServer/buffers'
        ...
        open() {
            axios.get('/api/work/wordcloud').then(
                res => {
                    ElMessageBox.alert('<img src="/api/static/wordcloud/res.png" class="wordcloud">', {
