    ...
    <div>
        ...
        <div class="body">
            <div class='upper'>
                ...
                <div>
                    <div class="prediction">
                        <el-button type="primary" v-on:click="open()" style="width: 80%;">实时天气</el-button>
            ...
            <div class='low'>
                ...
                <div class="prediction">
                    <el-button type="primary" v-on:click="attaindata()">开始预测</el-button>
                    <el-button type="primary" v-on:click="showdata()">查询结果</el-button>
                </div>
            </div>
        </div>
    </div>
